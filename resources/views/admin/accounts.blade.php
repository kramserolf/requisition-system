        ...
        <div class="modal-header">
          ...
          <div class="modal-body">
             <input type="hidden" name="id" id="id">
              <div class="mb-3">
                <label for="account" class="form-label fw-bold">Item Name:</label>
                <input type="text" class="form-control form-control-sm" name="account" id="account" placeholder="e.g. Bondpaper, Ballpen">
              </div>
              <div class="mb-3">
